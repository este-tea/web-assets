...
<!--Billing Address Section-->
      <div id="billingAddressBlock">
          ...
          <div class="checkbox">
            <label>
              <input name="subscribeToEmail" type="checkbox">
              <span class="tds-radio-btn"></span>
      ...
      <div class="form-group">
        ...
        <input class="form-control" name="billingAddressLine" type="text" value="">
      ...
      <div class="form-group">
        ...
        <input class="form-control" name="billingAddressLineOptional" type="text" value="">
      ...
      <div class="form-group">
        ...
        <input class="form-control" name="billingCity" type="text" value="">
      ...
      <div class="form-group">
        <label for="">Zip: </label>
        <input class="form-control" name="billingZip" type="text" value="">
...
<div class="container">
  <div class="row">
        ...
        <label for="">Please select your preferred installation date.</label>
        ...
        <div class="form-group">
            <label for="">Please let us know about any specific scheduling considerations you’d like us to be aware of (optional):</label>
        ...
        <div class="form-group tds-form-group">
          <label for="homeNewConstruction">Is the house newly constructed?</label>
            <div class="radio">
              <label>
                <input type="radio" name="homeNewConstruction" value="no">
                <span class="tds-radio-btn"></span>
            ...
            <div class="radio">
              <label>
                <input type="radio" name="homeNewConstruction" value="new">
                <span class="tds-radio-btn"></span>
            ...
            <div class="radio">
              <label>
                <input type="radio" name="homeNewConstruction" value="yes">
                <span class="tds-radio-btn"></span>
  ...
  <div class="row" >
        ...
        <div class="form-group tds-form-group">
          <label for="existingPhoneLine">Is there a phone line installed at your Service Address?</label>
            <div class="radio">
              <label>
                <input type="radio" name="existingPhoneLine" value="no">
                <span class="tds-radio-btn"></span>
                <div class="label-text">No</div>
              </label>
            </div>
            <div class="radio">
              <label>
                <input type="radio" name="existingPhoneLine" value="yes">
                <span class="tds-radio-btn"></span>
                <div class="label-text">Yes</div>
              </label>
            </div>
            <div class="radio">
              <label>
                <input type="radio" name="existingPhoneLine" value="dont know">
                <span class="tds-radio-btn"></span>
                <div class="label-text">I don't know</div>
              </label>
...
<!--Display if name="existingPhoneLine" is value="yes"-->
        ...
        <div class="checkbox">
          <label>
            <input name="localPhoneServiceAgree" type="checkbox">
            <span class="tds-radio-btn"></span>
        ...
        <div class="checkbox">
          <label>
            <input name="longDistancePhoneServiceAgree" type="checkbox">
            <span class="tds-radio-btn"></span>
        ...
        <div class="checkbox">
          <label>
            <input name="certifyReadAuthorizationAgreement" type="checkbox">
            <span class="tds-radio-btn"></span>
        ...
        <div class="form-group tds-form-group">
          <label for="homeNewConstruction">Verification of Agreement</label>
          <div>Please provide either your date of birth or your mother's maiden name.</div>
            <div class="radio">
              <label>
                <input type="radio" name="verificationType" value="birthDate">
                <span class="tds-radio-btn"></span>
            ...
            <div class="radio">
              <label>
                <input type="radio" name="verificationType" value="mothersMaidenName">
                <span class="tds-radio-btn"></span>
              ...
              <span class="help-block" id="verificationType-error" style="display: none;"></span>
                    ...
                    <div id="birthDateInput" class="initiallyHidden" style="display: block;">
                        <div class="form-group">
                      ...
                      <div id="maidenNameInput" class="initiallyHidden" style="display: block;">
                        <div class="form-group">
                          <label for="">Mother's Maiden Name</label>
                          <input class="form-control" name="mothersMaidenName" type="text" value="">
